...
def __pars_args__():
    ...
    parser.add_argument('-gam', '--gamma', type=float, default=0.99, help='discounting factor')
    parser.add_argument('-lam', '--lam', type=float, default=0.95, help='discounting factor')
    parser.add_argument('-m_grad', '--max_grad_norm', type=float, default=0.5, help='max norm of the gradients')
    parser.add_argument('-ent_coef', '--ent_coef', type=float, default=0.01,
...
if __name__ == '__main__':
    ...
    with open('./data.json', 'w') as f:
        json.dump(expert_demostration, f)
